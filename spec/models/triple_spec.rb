...
describe Triple do
  ...
  before(:each) do
    ...
    @identifier = Constants::RGD_ID['631210']
    @item_type = "QTL"
    @node = RDF::Node.uuid
    @node_triple = RDF::Statement.new(@identifier, Constants::OBO_OWL['Subset'], @node)
  end
  ...
  describe "parse_file" do
    it "should generate triples from the loaded line" do
      ...
      Triple.should_receive(:parse).with(@line).and_return(@new_graph)
  ...
  describe "parse" do
    it "should parse the line" do
      ...
      taxon_array = [RDF::Statement.new(@identifier, Constants::UNIPROT_CORE['Taxon'], Constants::UNIPROT_TAXONOMY['10116'])]
...
#      Triple.should_receive(:generate_title).with(@identifier, "Bw3")
      ...
      Triple.parse("RGD	631210	Bw3		MP:0000010	RGD:619690|PMID:11087657	QTM		N	Obesity QTL 3		qtl	taxon:10116	20100821	RGD		").should == @graph
    end
  end
  ...
  describe "creating triples" do
    ...
    describe "identifier" do
      # <http://purl.org/obo/owl/RGD#RGD_631210>
       it "should generate the identifier uri" do
        ...
        Triple.generate_identifier("MP", "0000010").should == Constants::PURL_OWL['MP#MP_0000010']
      end
    end
    ...
    describe "node" do
      it "should generate a blank node" do
        ...
        node_triple.predicate.should == Constants::RGD_CORE['hasOntologyAnnotation']
    ...
    describe "item_type" do
      ...
      it "should return the item type triple" do
        ...
        item_type.object.should ==  Constants::RGD_CORE['Qtl']
      end
    ...
    describe "date" do
      ...
      it "should return the date triple" do
        ...
        date.predicate.should == Constants::OBO_OWL['hasDate']
    ...
    describe "annotation" do
      ...
      it "should return the annotation triple" do
        ...
        annotation.predicate.should == Constants::RGD_CORE['hasOntologyId']
    ...
    describe "evidence_code" do
      ...
      it "should return the evidence_code triple" do
        ...
        evidence_code.predicate.should == Constants::RGD_CORE['hasEvidenceCode']
        evidence_code.object.should ==  RDF::Literal.new('QTM', :language => :en)
      end
    ...
    describe "domain" do
      ...
      it "should return the domain triple" do
        ...
        domain.object.should ==  Constants::PURL_OWL['RGD']
      end
    ...
    describe "taxons" do
      ...
      it "should return the taxons triples for single" do
        ...
        ['10116'].each_with_index do |taxon_id, i|
          ...
          taxons[i].predicate.should == Constants::UNIPROT_CORE['Taxon']
          taxons[i].object.should ==  Constants::UNIPROT_TAXONOMY[taxon_id]
        end
      end
    ...
    describe "synonyms" do
      ...
      it "should return the synonyms triples for single" do
        ...
        [['RGD', '1234']].each_with_index do |synonym, i|
          ...
          synomyms[i].predicate.should == Constants::OBO_OWL['hasSynonym']
    ...
    describe "db_references" do
      ...
      it "should return the db_references triples for single rgd" do
        ...
        db_references[0].predicate.should == Constants::OBO_OWL['hasDbXref']
      ...
      it "should return the db_references triples for single pmid" do
        ...
        db_references[0].subject.should == @node
        db_references[0].predicate.should == Constants::OBO_OWL['hasDbXref']
        db_references[0].object.should == Constants::PMID['11087657']
      end
      ...
      it "should return the db_references triples" do
        ...
        db_references[1].predicate.should == Constants::OBO_OWL['hasDbXref']
        db_references[1].object.should == Constants::PMID['11087657']
      end
